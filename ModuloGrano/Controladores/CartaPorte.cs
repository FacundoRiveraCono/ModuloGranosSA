...
namespace ModuloGrano.Controladores
{
    class CartaPorte
    {
        ...
        public string ArmarEquivalencias(string Codigo)
        {
        ...
        private string ReenvioSL(HttpResponseMessage result, string Codigo)
        {
        ...
        public WSAfip.autorizarCPEAutomotorResponse PostCartaPorte(Objetos.CartaPorte.Value oCartaPorte, string Codigo)
        {
            ...
            try
            {
                ...
                CPEOrigenPr.codProvincia = Convert.ToInt16(oCartaPorte.LocalidadDestino);
                ...
                if (!String.IsNullOrEmpty(oCartaPorte.CUITCorredorVentaSecundaria))
                {
                    ...
                    CPEInter.cuitCorredorVentaSecundaria = Convert.ToInt64(oCartaPorte.CUITRemitenteComercialVentaSecundaria);
                }
                else
                {
                ...
                //if (!String.IsNullOrEmpty(oCartaPorte.cuitr))
                //{
                ...
                //Datos de carga
                //Codigo de Grano
                CPECarga.codGrano = 23; //Convert.ToInt16(oCartaPorte.CodigoGrano);
