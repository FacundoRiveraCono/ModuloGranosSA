        ...
        private Objetos.PurchaseOrders ReenvioSL(HttpResponseMessage result, Objetos.PurchaseOrders oPurchase)
        {
            ...
            try
            {
                ...
                if (result.StatusCode == HttpStatusCode.OK)
                {
                    ...
                    {
                        oLines.ItemCode = item.ItemCode;
                        oLines.CostingCode = item.Norma1;
                        oLines.CostingCode2 = item.Norma2;
                        oLines.CostingCode3 = item.Norma3;
                        oLines.CostingCode4 = item.Norma4;
                        oLines.CostingCode5 = item.Norma5;
                        oLines.Quantity = 1;
                        oLines.Price = (double)item.ImporteNeto;
